...
type QEightProps = UserTextData & {
  updateTextArea: (textArea: Partial<UserTextData> ) => void
}

export function QEight({motivation, updateTextArea}: QEightProps){
 
  let introQ8
 = selfQ.find((selfOne) => selfOne.id === 8)
  return(
...
<div className="relative w-full min-w-[200px]">
    ...
    name="motivation"
    value={motivation}
    onChange={e => updateTextArea({motivation: e.target.value})}
